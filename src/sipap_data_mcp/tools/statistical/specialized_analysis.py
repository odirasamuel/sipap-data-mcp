...
import asyncpg
from .base import BaseStatisticalTool, DataQualityClassifier
...
async def get_total_goals_range(
    ...
    if not all_matches:
        return {
            ...
            "data": {"total_matches": 0, "most_common_range": None, "percentiles": {}},
...
async def get_home_either_half_outcome(
    ...
    if not matches_with_ht:
        return {
            ...
            "data": {"total_matches": 0, "tendency": None, "probabilities": {}},
...
async def get_home_to_score(pool, home_team, away_team, league, **kwargs):
    ...
    if not all_matches:
        return {
            ...
            "data": {"total_matches": 0, "home_to_score_probability": 0.0},
            "metadata": {"data_quality": "low"}
        }
...
async def get_away_to_score(pool, home_team, away_team, league, **kwargs):
    ...
    if not all_matches:
        return {
            ...
            "data": {"total_matches": 0, "away_to_score_probability": 0.0},
            "metadata": {"data_quality": "low"}
        }
